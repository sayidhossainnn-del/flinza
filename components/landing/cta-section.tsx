            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="flex-1">
                ...
                <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-xl">
                  Book a free audit and we&apos;ll tell you exactly why your ads aren&apos;t converting — and how to fix it.
                </p>
                ...
                <p className="text-sm text-muted-foreground mt-8 font-mono">No commitment. Just honest feedback on your ads.</p>
              </div>
