...
const steps = [
  {
    number: "I",
    title: "Free Creative Audit",
    description: "Book a call, share your current ads. We review your creatives, identify exactly why they're not converting, and map out a winning creative strategy.",
    code: `// What we audit
flinza.audit({
  currentCreatives: true,
  adAccount: 'meta',
  identify: [
    'conversion_blockers',
    'hook_weaknesses',
  ...
  },
  {
    ...
    description: "We script, direct, and produce raw authentic UGC built around your offer and customer psychology. New creatives in your hands within 5–7 days.",
    code: `flinza.produce({
  type: 'UGC',
  platform: 'meta_feeds',
  built_around: [
  ...
  {
    number: "III",
    title: "Test, Scale & Report",
    description: "We set up systematic A/B tests, track ROAS, CTR, and purchase data, and scale what works. Most clients see measurable improvement within 30 days.",
    code: `flinza.scale({
  testing: 'systematic_AB',
  track: ['ROAS', 'CTR', 'purchases'],
  timeline: '30 days to results'
})

// Average ROAS improvement: +340%`,
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="mb-16 lg:mb-24">
          ...
          <h2 className={`text-4xl lg:text-6xl font-display tracking-tight transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            Three steps.
            <br />
            <span className="text-background/50">Better ROAS.</span>
          </h2>
        </div>
          ...
          <div className="lg:sticky lg:top-32 self-start">
            <div className="border border-background/10 overflow-hidden">
              <div className="px-6 py-4 border-b border-background/10 flex items-center justify-between">
                ...
                <span className="text-xs font-mono text-background/40">flinza.ts</span>
              </div>
