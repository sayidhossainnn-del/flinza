...
const features = [
  {
    ...
    description: "Raw, authentic user-generated content that outperforms polished studio ads. Built for Meta feeds and scripted around your customer psychology.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Ad Creative Strategy",
    description: "We audit your existing creatives, identify why they're failing, and build a winning creative roadmap tied directly to your funnel.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Creative Testing Frameworks",
    description: "Systematic A/B testing setups so you always know what's working. When a creative wins, we scale it fast.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Performance Creative Reporting",
    description: "Clear reporting that connects your creatives directly to ROAS, CTR, and purchase data. No vanity metrics.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="mb-16 lg:mb-24">
          ...
          <h2 className={`text-4xl lg:text-6xl font-display tracking-tight transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            End-to-end creative
            <br />
            <span className="text-muted-foreground">for DTC brands.</span>
          </h2>
        </div>
        <div>
